 ...
 *
 * your name: Ethan Chang
 * chang115@bu.edu
 * 
 * partner name: Seoyeon Leepuzzle2.txt
 * leeseo@bu.edu
 */
...
public class Sudoku {    
    ...
    private boolean[][]checkRowVal;
    private boolean[][]checkColVal;
    ...
    public Sudoku() {
        ...
        this.checkRowVal = new boolean[9][10];
        this.checkColVal = new boolean[9][10];
    }
    ...
    public void placeVal(int val, int row, int col) {
        ...
        this.checkRowVal[row][val] = true;
        this.checkColVal[col][val] = true;
    }
    ...
    public void removeVal(int val, int row, int col) {
        ...
        /*** UPDATE YOUR ADDITIONAL FIELDS HERE. ***/
        this.checkRowVal[row][val] = false;
        this.checkColVal[col][val] = false;
    }  
    ...
    private boolean solveRB(int n) {
        ...
        for (int i = 1; i <= 9; i++) {
            if (checkRowVal[r][i] == false && checkColVal[c][i] == false && subgridHasVal[r/3][c/3][i] == false) {
                placeVal(i, r, c);
